...
def getJsonHtml(url,params,cookie):
    ...
    headers = {
        ...
        'cookie': cookie,
        'referer':'https://weibo.com/7204464603/QD6GbBOdT'
    }
...
def writeToCsv(row):
    ...
    :return:
    '''
    with open('data/specificRepost_data.csv', 'a', encoding='utf8', newline='') as file:
        writer= csv.writer(file)
        writer.writerow(row)
...
def start():
    ...
    for article in articleList:
        ...
        if reposts_count > 10:
            ...
            pageCount=(reposts_count-10)/20+1
            if pageCount > 100:
                pageCount=100
